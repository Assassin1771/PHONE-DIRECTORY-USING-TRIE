...
class hashing
{
    ...
    void create(int size) // takes user details as input from and saves the record in the hashtable
    {
        cout<<"\nEnter ID: ";
        cin>>i;
        cout<<"\nEnter name: ";
    ...
    void displayContactsUtil(TrieNode *curNode, string prefix)//displays all the contact details with respect to prefix
    {
        if (curNode->isLast) 
		    cout << prefix << endl; 
